...
public class Class_0_HelloWorld {
	...
	protected int ssn = 123451526; // protected - Only same package & subclass
									// can access it

	String address = "Hertiage Tower"; // default - works as public, only by
	...
	// Static Variable
	static String zip = "07124"; // Static variable store memory in class, not
									// required create object
